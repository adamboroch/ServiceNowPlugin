...
- **Reconcile:** Requires a **Reconcile account** with sufficient privileges to reset other users’ passwords. **user_admin** builtin role is enough for that purpose- "Can administer users, groups, locations, and companies"
