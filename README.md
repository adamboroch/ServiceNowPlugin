...
- **Output DLL path:**
- C:\Users<yourusername>\source\repos\ServiceNowPlugin\bin\**Release**\ServiceNowPlugin.dll ( Relese | Debug - depends on what option did you choose during Project compile)
